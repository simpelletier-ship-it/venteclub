            ...
            {user ? (
              <>
                <Button
                  ...
                  className="hidden md:flex bg-[hsl(var(--secondary))] hover:bg-[hsl(var(--secondary))]/90 text-secondary-foreground font-semibold shadow-lg"
                >
                  Je vends
                </Button>
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      <Avatar className="h-10 w-10 border-2 border-primary/40 hover:border-primary transition-colors">
                        ...
                        <AvatarFallback className="bg-[hsl(var(--secondary))] text-secondary-foreground font-semibold">
              ...
              <>
                ...
                <Button
                  onClick={() => navigate("/sell")}
                  className="hidden md:inline-flex bg-[hsl(var(--secondary))] hover:bg-[hsl(var(--secondary))]/90 text-secondary-foreground font-semibold"
                >
                  Je vends
                </Button>
              </>
          ...
          <div className="md:hidden mt-4 pb-4 space-y-2 border-t border-border pt-4 animate-slide-up">
            ...
            {isAdmin && (
              <button
                ...
                className="w-full text-left px-4 py-2 rounded-lg hover:bg-accent transition-colors flex items-center gap-2 text-primary"
              >
                <Sparkles className="w-4 h-4" />
                Admin
              </button>
            ...
            <Button
              ...
              className="w-full bg-[hsl(var(--secondary))] hover:bg-[hsl(var(--secondary))]/90 text-secondary-foreground font-semibold mt-4"
            >
              Je vends
            </Button>
          </div>
