      ...
      {status === 'sold' && (
        <div className="absolute inset-0 z-[5] bg-background/40 backdrop-blur-[1px] pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-[-25deg] w-[140%]">
            <div className="relative bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-600 text-white py-5 px-8 shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
              <div className="absolute inset-0 bg-white/10 backdrop-blur-sm"></div>
              <p className="relative text-3xl md:text-4xl font-bold text-center tracking-[0.3em] uppercase">
                VENDU
              </p>
