    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle>Mon actif net</CardTitle>
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="max-w-md">
              <DialogHeader>
                <DialogTitle>Enregistrer mon actif net</DialogTitle>
                <DialogDescription>
                  Enregistrez un snapshot de votre situation financière à une date donnée
                </DialogDescription>
              </DialogHeader>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <Label>Total de mes dettes 💳</Label>
                  <CurrencyInput
                    value={totalDebts}
                ...
                <div className="bg-muted/50 rounded-lg p-4">
                  <div className="text-sm text-muted-foreground mb-2">Aperçu de votre actif net</div>
                  ...
                  <div className="pt-2 border-t flex items-center justify-between">
                    <span className="font-medium">Actif net</span>
                ...
                <Button type="submit" className="w-full" disabled={recordSnapshot.isPending}>
                  {recordSnapshot.isPending ? "Enregistrement..." : "Enregistrer le bilan"}
                </Button>
              </form>
            </DialogContent>
          </Dialog>
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground">
          ...
          Le graphique ci-dessous montre votre progression dans le temps.
        </p>
      </CardContent>
    </Card>
  );
