            ...
            {loading ? (
              ...
              <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <Card 
                    className="cursor-pointer hover:shadow-lg transition-all border-2 hover:border-[#FF6B00]/50"
                    onClick={() => navigate("/list-franchise")}
                  >
                    <CardContent className="p-6 text-center space-y-4">
                      <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#FF6B00]/10">
                  ...
                  <Card 
                    className="cursor-pointer hover:shadow-lg transition-all border-2 hover:border-green-600/50"
                    onClick={() => navigate("/list-property")}
                  >
                    <CardContent className="p-6 text-center space-y-4">
                      <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-green-600/10">
