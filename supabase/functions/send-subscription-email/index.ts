          ...
          <body>
            <div class="container">
              ...
              <div class="footer">
                ...
                <p style="margin-top: 10px;">Cette facture a été générée automatiquement par notre système.</p>
                <p style="margin-top: 10px;">
                  <a href="https://vente.club/terms" style="color: #666; text-decoration: none;">Conditions d'utilisation</a> | 
                  <a href="https://vente.club/settings" style="color: #666; text-decoration: none;">Gérer mon abonnement</a>
                </p>
              </div>
            </div>
          </body>
