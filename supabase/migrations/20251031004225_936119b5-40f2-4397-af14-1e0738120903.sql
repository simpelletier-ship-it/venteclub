-- Update use_token_for_access function to track analytics when unlocking contact
...
BEGIN
  ...
  IF user_has_premium THEN
    ...
    -- Track analytics for contact unlock
    INSERT INTO business_analytics (business_id, event_type, user_id)
    VALUES (business_uuid, 'contact_unlock', auth.uid());
